...
envsubst < ./clusters/lovenet/apps/media/stash/tmpl/secrets-tmpl.yaml > ./clusters/lovenet/apps/media/stash/secrets.yaml
...
sops --encrypt --in-place ./clusters/lovenet/apps/media/stash/secrets.yaml
