...
envsubst < ./clusters/lovenet/apps/flux-system/webhook/tmpl/secrets-tmpl.yaml > ./clusters/lovenet/apps/flux-system/webhook/secrets.yaml
...
sops --encrypt --in-place ./clusters/lovenet/apps/flux-system/webhook/secrets.yaml
