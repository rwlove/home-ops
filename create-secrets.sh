...
sops --encrypt ./clusters/lovenet/apps/downloads/qbittorrent/config/categories.json > ./clusters/lovenet/apps/downloads/qbittorrent/config/categories.sops.json
