...
podman run --network host --rm ghcr.io/kube-vip/kube-vip:v1.0.2 manifest pod --interface $INTERFACE --vip $VIP --vipSubnet "/32" --controlplane --services --arp --leaderElection | tee /etc/kubernetes/manifests/kube-vip.yaml
